...
<body class="subpage-background">
  <div data-collapse="medium" data-animation="default" data-duration="400" class="nav-bar w-nav" data-ix="new-interaction-2">
    <div class="container w-container">
      ...
      <nav role="navigation" class="nav-menu w-nav-menu"><a href="aboutus" class="nav-link w-nav-link">aBOUT<br>US</a><a href="howitworks" class="nav-link w-nav-link">how<br>it works</a><a href="hottracks" class="nav-link w-nav-link"><span class="text-span-5">Hot</span><br>tracks</a><a href="oureditors" class="nav-link w-nav-link w--current">our<br>editors</a><a href="https://v2-docs.crooklynclan.net/newsetup/gearshop" target="_blank" class="nav-link gs w-nav-link">gear<br>shop</a><a href="contact" class="nav-link ctu w-nav-link">contact<br>us</a><a href="<?php echo config_item('front_url'); ?>" class="nav-link lisu w-nav-link">Login / Signup</a></nav>
  ...
  <div class="content-wrapper w-container">
    ...
    <div class="editorhold">
      <div class="dbee"><img src="<?php echo base_url(); ?>images/avnicehead.png" srcset="<?php echo base_url(); ?>images/avnicehead-p-500.png 500w, <?php echo base_url(); ?>images/avnicehead.png 1024w" sizes="(max-width: 767px) 98vw, (max-width: 991px) 718px, 930px">
      ...
      <div class="dbee"><img src="<?php echo base_url(); ?>images/vvheaddtry.png" srcset="<?php echo base_url(); ?>images/vvheaddtry-p-500.png 500w, <?php echo base_url(); ?>images/vvheaddtry.png 1024w" sizes="(max-width: 767px) 98vw, (max-width: 991px) 718px, 930px">
      ...
      <div class="dbee"><img src="<?php echo base_url(); ?>images/i12pooltry.png" srcset="<?php echo base_url(); ?>images/i12pooltry-p-800.png 800w, <?php echo base_url(); ?>images/i12pooltry.png 1024w" sizes="(max-width: 767px) 98vw, (max-width: 991px) 718px, 930px">
